                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      📊 Showing Zillow scraped leads (visible to all users) and your manually created leads
                    </p>
                  </div>
                  <Link
                    href="/leads/new"
              ...
              <div className="bg-white rounded-lg shadow overflow-hidden">
                {leads.length === 0 ? (
                  <div className="text-center py-12">
                    <div className="text-gray-400 text-xl mb-4">No leads found</div>
                          ...
                          {leads.map((lead) => (
                            <tr key={lead.id} className="hover:bg-gray-50">
                              <td className="px-6 py-4 whitespace-nowrap">
                                <div>
                                  ...
                                  <div className="text-sm text-gray-500">
                                    {lead.price && <span className="mr-2">${lead.price}</span>}
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                {lead.contacts?.length > 0 ? lead.contacts[0].phoneNumber : 'No phone'}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap">
